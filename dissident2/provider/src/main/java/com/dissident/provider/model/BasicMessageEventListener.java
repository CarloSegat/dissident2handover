package com.dissident.provider.model;
    ...
    public void onVerificationEvent(VerificationEvent event) {
        ...
        if(event.getSrc().equals("provider")){
            ...
            SendMessage messageToSend = SendMessage.builder()
                .content("{\"messageType\": \"ServiceUsageResponse\",\"qrCode\": \"https://api.qrserver.com/v1/create-qr-code/?size=500x500&data=https://arxiv.org/html/2310.19366v3\"}")
                .build();
